...
//        monthBackgroundColor = typedArray.getColor(R.styleable.WeekCalendar_monthBackgroundColor, Color.LTGRAY);
    ...
    private void getWholeMonthDatas(CalendarData data) {
        ...
        if (null != onCurrentMonthDateListener) {
...
//        month_layout.setBackgroundResource(monthBackgroundColor);
//        mRvDay.setBackgroundResource(weekBackgroundColor);
    ...
    public class CalendarAdapter extends SimpleBaseAdapter {
        ...
        public View getItemView(final int position, View convertView, final ViewHolder viewHolder) {
            ...
            final LinearLayout linearLayout = (LinearLayout) viewHolder.getView(R.id.ll_wd_view);
            final LinearLayout llDateView = (LinearLayout) viewHolder.getView(R.id.ll_date_view);
...
//            weekView.setBackgroundColor(weekBackgroundColor);
            ...
            if (calendar.isSameDay(theDayOfSelected)) {//被选中的日期是白的
                ...
                linearLayout.setBackgroundResource(R.drawable.shape_sec_type);
                ...
                dayView.setTextColor(Color.parseColor("#8890a3"));
                weekView.setTextColor(Color.parseColor("#596279"));
                linearLayout.setBackgroundColor(Color.WHITE);
//                dayView.setBackgroundDrawable(null);
//                dayView.setTextColor(weekTextColor);
            }

            if (null != selectDateList) {
            ...
            //如果设置了回调，则设置点击事件
            llDateView.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
